...
export default function Index() {
  return (
    <div className='h-full relative flex justify-center items-center group'>
      <div className='h-full scale-120 absolute'>
        <Image src={map} alt={"Colombian map"} style={{objectFit: 'cover', height: '100%'}}/>
      </div>
      <div className='flex flex-col absolute justify-center items-center gap-[2px] group-hover:animate-bounce-once'>
